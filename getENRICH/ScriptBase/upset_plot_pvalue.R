...
# Define individual text scale components
text_scale_sets <- 1
text_scale_matrix_points <- 1
text_scale_main_bar <- 1
text_scale_set_size <- 1
text_scale_labels <- 0.8
text_scale_legend <- 1
...
upset(
  ...
  matrix.color = "red",
  main.bar.color = "blue",
  text.scale = c(text_scale_sets, text_scale_matrix_points, text_scale_main_bar, text_scale_set_size, text_scale_labels, text_scale_legend),  # Adjust text sizes for different labels
